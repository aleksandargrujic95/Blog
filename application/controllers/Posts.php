<?php 
		...
		public function create(){
			...
			if ($this->form_validation->run() === FALSE) {
				...
				if (!$this->upload->do_upload()) {
					...
					$post_image1 = $_FILES['userfile']['name'];

				}

				$this->post_model->create_post($post_image1);
				// Set message
		...
		public function delete_image1()
    {
            ...
            $post_picture = $this->input->post('post_image1');

            $this->post_model->delete_post_image1($post_id, $post_image1);
